...
RUN wget http://nginx.org/packages/mainline/centos/8/SRPMS/nginx-1.25.5-1.el8.ngx.src.rpm -O /root/rpmbuild/SRPMS/nginx-1.25.5-1.el8.ngx.src.rpm
RUN wget https://github.com/vozlt/nginx-module-vts/archive/master.zip -O /root/rpmbuild/SOURCES/nginx-module-vts_master.zip
RUN rpm -Uvh /root/rpmbuild/SRPMS/nginx-1.25.5-1.el8.ngx.src.rpm
